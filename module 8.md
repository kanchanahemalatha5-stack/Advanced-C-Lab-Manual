...
```
## Output:
<img width="806" height="362" alt="image" src="https://github.com/user-attachments/assets/845f9ac1-3f0b-4794-8d9c-7d4ddc1c22de" />
...
```
## Output:
<img width="825" height="222" alt="image" src="https://github.com/user-attachments/assets/a2a470aa-b606-4cbd-93eb-a19abbb93698" />
## Result:
Thus, the program is verified successfully
...
```
## Output:
<img width="691" height="542" alt="image" src="https://github.com/user-attachments/assets/94beb834-d4df-4748-a9ea-eed2a5318f6f" />
...
```
## Output:
<img width="805" height="707" alt="image" src="https://github.com/user-attachments/assets/373cc4b9-8012-4513-bdda-38be8323f0ce" />
